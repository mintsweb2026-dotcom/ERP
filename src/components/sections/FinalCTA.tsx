  ...
  return (
    <section className="py-16 sm:py-20 lg:py-28 bg-white" ref={ref}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl bg-[#1C210E] text-white p-6 sm:p-10 md:p-16 text-center shadow-2xl shadow-[#1C210E]/20 overflow-hidden">
          {/* Ambient Olive Glows */}
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#353E20] border border-[#515E2C] text-xs font-semibold text-[#C3D2A3] mb-5 sm:mb-6"
            >
